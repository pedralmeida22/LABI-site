...
\renewcommand{\abstractname}{Agradecimentos}
	\begin{abstract}
		Queríamos agradecer a todos os intervenientes que contribuíram de 		alguma forma para a resolução de eventuais problemas durante a 			  	elaboração deste relatório.
	\end{abstract}
...
completar amanha (já criei os acronimos)

(só uma ideia)
os dois elementos do grupo estiveram em sintonia, discutindo as ideias para a elaboração do trabalho e estando sempre os dois presentes na elaboraçao do mesmo... propondo uma percentagem de elaboração do trabalho de:

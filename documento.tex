...
\vspace{1mm}	
	...
	O UNISERVO usava uma fita de metal, com 13 mm de largura, feita de uma liga níquel-bronze de fósforo (chamado Vicalloy) e tinha 1200 metros de comprimento, e sendo esta incrivelmente pesada.
\vspace{1mm}
	
	Os dados são guardados em 8 secções da fita, onde 6 eram para os valores dos dados (1 ou 0), 1 para a verificação de erros
\vspace{1mm}
%\chapter{Análise}
%\label{chap.analise}
